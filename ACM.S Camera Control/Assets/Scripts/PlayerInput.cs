...
{
    public static KeyCode JumpKey, JumpKey1, JumpKey2, UpKey, UpKey1, DownKey, DownKey1, LeftKey, LeftKey1, RightKey, RightKey1;
    ...
    {
        return Input.GetKeyDown(JumpKey) || Input.GetKeyDown(JumpKey1) || Input.GetKeyDown(JumpKey2);
    }
    public static bool JumpHeld()
    {
        return Input.GetKey(JumpKey) || Input.GetKey(JumpKey1) || Input.GetKey(JumpKey2);
    }
    public static bool JumpReleased()
    {
        return Input.GetKeyUp(JumpKey) || Input.GetKeyUp(JumpKey1) || Input.GetKeyUp(JumpKey2);
    }
    ...
    {
        return Input.GetKeyDown(AttackKey) || Input.GetKeyDown(AttackKey1) || Input.GetMouseButtonDown(0);
    }
